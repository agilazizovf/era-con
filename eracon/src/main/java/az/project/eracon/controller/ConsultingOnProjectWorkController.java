...
import az.project.eracon.service.ConsultingOnProjectWorkService;
...
@MyRestController
@RequestMapping("/api/consulting-on-project-works")
@RequiredArgsConstructor
public class ConsultingOnProjectWorkController {
