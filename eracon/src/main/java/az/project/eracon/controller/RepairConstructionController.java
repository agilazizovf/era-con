...
import az.project.eracon.service.RepairConstructionService;
...
@MyRestController
@RequestMapping("/api/repair-constructions")
@RequiredArgsConstructor
public class RepairConstructionController {

    private final RepairConstructionService service;
